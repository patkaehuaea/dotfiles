...
au BufRead,BufNewFile *.{yaml,yaml} set filetype=yaml
au BufRead,BufNewFile *.{yaml,yaml} set tabstop=2
au BufRead,BufNewFile *.{yaml,yaml} set shiftwidth=2
au BufRead,BufNewFile *.{yaml,yaml} set softtabstop=2
